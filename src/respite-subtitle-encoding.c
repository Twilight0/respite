...
const char *
respite_subtitle_encoding_get_selected(GtkComboBox * combo) {
  GtkTreeModel *model;
  GtkTreeIter iter;
  gint index_i = -1;
...
void
respite_subtitle_encoding_set(GtkComboBox * combo, const char *encoding) {
  GtkTreeModel *model;
  GtkTreeIter iter, iter2;
  gint index_i, i;
...
void
respite_subtitle_encoding_init(GtkComboBox *combo) {
  GtkTreeModel *model;
