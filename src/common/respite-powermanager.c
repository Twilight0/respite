...
#include "respite-powermanager.h"
...
guint32
respite_power_manager_inhibit (GDBusConnection *connection) {
    GVariant *reply;
    GError   *error = NULL;
    guint32   cookie;
...
void
respite_power_manager_uninhibit (GDBusConnection *connection,
                                guint32          cookie)
{
    GVariant *reply;
    GError   *error = NULL;
...
GDBusConnection *
respite_power_manager_dbus_init (void)
{
