...
#include "data/mime/respite-mime-types.h"
...
/**
 * respite_get_supported_audio_filter:
 *
 *
 ...
 * Since: 0.2
 */
GtkFileFilter *respite_get_supported_audio_filter(void) {
...
/**
 * respite_get_supported_video_filter:
 *
 *
 * Get a #GtkFileFilter according to the supported
 ...
 * Since: 0.2
 */
GtkFileFilter *respite_get_supported_video_filter(void) {
    GtkFileFilter *filter;
    guint i;
...
/**
 * respite_get_supported_media_filter:
 *
 * Get a #GtkFileFilter according to the supported
 ...
 * Since: 0.2
 */
GtkFileFilter *respite_get_supported_media_filter(void) {
    GtkFileFilter *filter;
    guint i;
...
/**
 * respite_get_supported_recent_media_filter:
 *
 ...
 * Since: 0.2
 */
GtkRecentFilter *respite_get_supported_recent_media_filter(void) {
...
/**
 * respite_get_supported_files_filter:
 *
 * Get a #GtkFileFilter according to the supported
 * Parole file mime types, including audio/video/playlist formats.
 *
 ...
 * Since: 0.2
 */
GtkFileFilter *respite_get_supported_files_filter(void) {
    GtkFileFilter *filter;
    guint i;
...
/**
 * respite_get_supported_recent_files_filter:
 *
 * Get a #GtkRecentFilter according to the supported
 * Parole file mime types, including audio/video/playlist formats.
 *
 ...
 * Since: 0.2
 */
GtkRecentFilter *respite_get_supported_recent_files_filter(void) {
    GtkRecentFilter *filter;
    guint i;

    filter = respite_get_supported_recent_media_filter();
...
/**
 * respite_get_supported_playlist_filter:
 *
 * Get a #GtkFileFilter according to the supported
 ...
 * Since: 0.2
 */
GtkFileFilter *respite_get_supported_playlist_filter(void) {
    GtkFileFilter *filter;
    guint i;
 ...
 * Since: 0.2
 */
gboolean respite_file_filter(GtkFileFilter *filter, RespiteFile *file) {
    GtkFileFilterInfo filter_info;

    gboolean ret;

    filter_info.display_name = respite_file_get_display_name(file);
    filter_info.mime_type = respite_file_get_content_type(file);
